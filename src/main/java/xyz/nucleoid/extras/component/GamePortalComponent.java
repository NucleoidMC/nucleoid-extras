...
public record GamePortalComponent(ResourceLocation gamePortalId) implements PolymerComponent {
    public static final Codec<GamePortalComponent> CODEC = RecordCodecBuilder.create(instance ->
        instance.group(
                ResourceLocation.CODEC.fieldOf("game_portal_id").forGetter(GamePortalComponent::gamePortalId)
