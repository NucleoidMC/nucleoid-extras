...
public class NEItems {
    public static final ItemGroup ITEM_GROUP = PolymerItemGroupUtils.builder(NucleoidExtras.identifier("general"))
        ...
        .entries((context, entries) -> {
            ...
            entries.add(NEItems.TINY_POTATO);
            entries.add(NEItems.IRRITATER);
            entries.add(NEItems.SAD_TATER);
            entries.add(NEItems.FLOWERING_AZALEA_TATER);
            entries.add(NEItems.STONE_TATER);
            entries.add(NEItems.CALCITE_TATER);
            entries.add(NEItems.TUFF_TATER);
            entries.add(NEItems.BASALT_TATER);
            entries.add(NEItems.DRIPSTONE_TATER);
            entries.add(NEItems.AMETHYST_TATER);
            entries.add(NEItems.PACKED_ICE_TATER);
            entries.add(NEItems.BLUE_ICE_TATER);
            entries.add(NEItems.FLAME_TATER);
            entries.add(NEItems.PUZZLE_CUBE_TATER);
            entries.add(NEItems.LUCKY_TATER);
            entries.add(NEItems.CRATE_TATER);
            entries.add(NEItems.TATER_OF_UNDYING);
            entries.add(NEItems.CRYING_OBSIDIAN_TATER);
            entries.add(NEItems.DICE_TATER);
            entries.add(NEItems.TRANS_TATER);
            entries.add(NEItems.ASEXUAL_TATER);
            entries.add(NEItems.BI_TATER);
            entries.add(NEItems.GAY_TATER);
            entries.add(NEItems.LESBIAN_TATER);
            entries.add(NEItems.NONBINARY_TATER);
            entries.add(NEItems.PAN_TATER);
            entries.add(NEItems.WARDEN_TATER);
            entries.add(NEItems.VIRAL_TATER);
            entries.add(NEItems.TATEROID);
            entries.add(NEItems.RED_TATEROID);
            entries.add(NEItems.ORANGE_TATEROID);
            entries.add(NEItems.YELLOW_TATEROID);
            entries.add(NEItems.GREEN_TATEROID);
            ...
            entries.add(NEItems.SKELETATER);
            entries.add(NEItems.WITHER_SKELETATER);
            entries.add(NEItems.ZOMBIE_TATER);
            entries.add(NEItems.CREEPER_TATER);
            entries.add(NEItems.STEVE_TATER);
            entries.add(NEItems.ALEX_TATER);
            entries.add(NEItems.WHITE_TATER);
            entries.add(NEItems.ORANGE_TATER);
            entries.add(NEItems.MAGENTA_TATER);
            entries.add(NEItems.LIGHT_BLUE_TATER);
            entries.add(NEItems.YELLOW_TATER);
            entries.add(NEItems.LIME_TATER);
            entries.add(NEItems.PINK_TATER);
            entries.add(NEItems.GRAY_TATER);
            entries.add(NEItems.LIGHT_GRAY_TATER);
            entries.add(NEItems.CYAN_TATER);
            entries.add(NEItems.PURPLE_TATER);
            entries.add(NEItems.BLUE_TATER);
            entries.add(NEItems.BROWN_TATER);
            entries.add(NEItems.GREEN_TATER);
            entries.add(NEItems.RED_TATER);
            entries.add(NEItems.BLACK_TATER);
            entries.add(NEItems.COAL_TATER);
            entries.add(NEItems.DIAMOND_TATER);
            entries.add(NEItems.EMERALD_TATER);
            entries.add(NEItems.GOLD_TATER);
            entries.add(NEItems.IRON_TATER);
            entries.add(NEItems.LAPIS_TATER);
            entries.add(NEItems.NETHERITE_TATER);
            entries.add(NEItems.QUARTZ_TATER);
            entries.add(NEItems.REDSTONE_TATER);
            entries.add(NEItems.COPPER_TATER);
            entries.add(NEItems.EXPOSED_COPPER_TATER);
            entries.add(NEItems.WEATHERED_COPPER_TATER);
            entries.add(NEItems.OXIDIZED_COPPER_TATER);
            entries.add(NEItems.CAKE_TATER);
            entries.add(NEItems.ENDERTATER);
            entries.add(NEItems.FURNACE_TATER);
            entries.add(NEItems.MELON_TATER);
            entries.add(NEItems.PUMPKIN_TATER);
            entries.add(NEItems.JACK_O_TATER);
            entries.add(NEItems.SCULK_TATER);
            entries.add(NEItems.SLIME_TATER);
            entries.add(NEItems.HEROBRINE_TATER);
            entries.add(NEItems.OCHRE_FROGLIGHT_TATER);
            entries.add(NEItems.PEARLESCENT_FROGLIGHT_TATER);
            entries.add(NEItems.VERDANT_FROGLIGHT_TATER);
            entries.add(NEItems.SNOWMAN_TATER);
            entries.add(NEItems.ACACIA_TATER);
            entries.add(NEItems.ANDESITE_TATER);
            entries.add(NEItems.BAMBOO_TATER);
            entries.add(NEItems.BEDROCK_TATER);
            entries.add(NEItems.BIRCH_TATER);
            entries.add(NEItems.BONE_TATER);
            entries.add(NEItems.BRAIN_CORAL_TATER);
            entries.add(NEItems.BRICK_TATER);
            entries.add(NEItems.BUBBLE_CORAL_TATER);
            entries.add(NEItems.CACTUS_TATER);
            entries.add(NEItems.CHORUS_TATER);
            entries.add(NEItems.CLAY_TATER);
            entries.add(NEItems.CRIMSON_TATER);
            entries.add(NEItems.DARK_OAK_TATER);
            entries.add(NEItems.DARK_PRISMARINE_TATER);
            entries.add(NEItems.DIORITE_TATER);
            entries.add(NEItems.DIRT_TATER);
            entries.add(NEItems.END_STONE_TATER);
            entries.add(NEItems.FIRE_CORAL_TATER);
            entries.add(NEItems.GRANITE_TATER);
            entries.add(NEItems.GRASS_TATER);
            entries.add(NEItems.HAY_TATER);
            entries.add(NEItems.HONEY_TATER);
            entries.add(NEItems.HONEYCOMB_TATER);
            entries.add(NEItems.HORN_CORAL_TATER);
            entries.add(NEItems.JUNGLE_TATER);
            entries.add(NEItems.MYCELIUM_TATER);
            entries.add(NEItems.NETHER_WART_TATER);
            entries.add(NEItems.OAK_TATER);
            entries.add(NEItems.OBSIDIAN_TATER);
            entries.add(NEItems.PODZOL_TATER);
            entries.add(NEItems.PRISMARINE_BRICK_TATER);
            entries.add(NEItems.PRISMARINE_TATER);
            entries.add(NEItems.RED_SAND_TATER);
            entries.add(NEItems.SAND_TATER);
            entries.add(NEItems.SEA_LANTERN_TATER);
            entries.add(NEItems.SHROOMLIGHT_TATER);
            entries.add(NEItems.SHULKER_TATER);
            entries.add(NEItems.SMOOTH_STONE_TATER);
            entries.add(NEItems.SOUL_SAND_TATER);
            entries.add(NEItems.SPONGE_TATER);
            entries.add(NEItems.SPRUCE_TATER);
            entries.add(NEItems.STONE_BRICK_TATER);
            entries.add(NEItems.TARGET_TATER);
            entries.add(NEItems.TERRACOTTA_TATER);
            entries.add(NEItems.TNTATER);
            entries.add(NEItems.TUBE_CORAL_TATER);
            entries.add(NEItems.WARPED_TATER);
            entries.add(NEItems.WARPED_WART_TATER);
            entries.add(NEItems.WOOL_TATER);
            entries.add(NEItems.ACACIA_LOG_TATER);
            entries.add(NEItems.ANGRY_BEE_TATER);
            entries.add(NEItems.BEACON_TATER);
            entries.add(NEItems.BEE_NEST_TATER);
            entries.add(NEItems.BEE_TATER);
            entries.add(NEItems.BEEHIVE_TATER);
            entries.add(NEItems.BIRCH_LOG_TATER);
            entries.add(NEItems.BLACKSTONE_TATER);
            entries.add(NEItems.BLAZE_TATER);
            entries.add(NEItems.BOOKSHELF_TATER);
            entries.add(NEItems.BROWN_MOOSHROOM_TATER);
            entries.add(NEItems.BROWN_MUSHROOM_TATER);
            entries.add(NEItems.CAVE_SPIDER_TATER);
            entries.add(NEItems.COBBLED_DEEPSLATE_TATER);
            entries.add(NEItems.COBBLESTONE_TATER);
            entries.add(NEItems.COCOA_TATER);
            entries.add(NEItems.COLD_STRIDER_TATER);
            entries.add(NEItems.COW_TATER);
            entries.add(NEItems.CRAFTING_TATER);
            entries.add(NEItems.CRIMSON_NYLIUM_TATER);
            entries.add(NEItems.CRIMSON_STEM_TATER);
            entries.add(NEItems.DARK_OAK_LOG_TATER);
            entries.add(NEItems.DAYLIGHT_DETECTOR_TATER);
            entries.add(NEItems.DEAD_BRAIN_CORAL_TATER);
            entries.add(NEItems.DEAD_BUBBLE_CORAL_TATER);
            entries.add(NEItems.DEAD_FIRE_CORAL_TATER);
            entries.add(NEItems.DEAD_HORN_CORAL_TATER);
            entries.add(NEItems.DEAD_TUBE_CORAL_TATER);
            entries.add(NEItems.DEEPSLATE_BRICK_TATER);
            entries.add(NEItems.DEEPSLATE_TATER);
            entries.add(NEItems.DRIED_KELP_TATER);
            entries.add(NEItems.DROWNED_TATER);
            entries.add(NEItems.EYE_OF_ENDER_TATER);
            entries.add(NEItems.FOX_TATER);
            entries.add(NEItems.GHAST_TATER);
            entries.add(NEItems.GILDED_BLACKSTONE_TATER);
            entries.add(NEItems.GLOW_SQUID_TATER);
            entries.add(NEItems.GLOWSTONE_TATER);
            entries.add(NEItems.HUSK_TATER);
            entries.add(NEItems.INVERTED_DAYLIGHT_DETECTOR_TATER);
            entries.add(NEItems.JUNGLE_LOG_TATER);
            entries.add(NEItems.MAGMA_CUBE_TATER);
            entries.add(NEItems.MOOBLOOM_TATER);
            entries.add(NEItems.MUDDY_PIG_TATER);
            entries.add(NEItems.MUSHROOM_STEM_TATER);
            entries.add(NEItems.NETHER_BRICK_TATER);
            entries.add(NEItems.NETHERRACK_TATER);
            entries.add(NEItems.OAK_LOG_TATER);
            entries.add(NEItems.PIG_TATER);
            entries.add(NEItems.POLAR_BEAR_TATER);
            entries.add(NEItems.PUFFERTATER);
            entries.add(NEItems.RED_MOOSHROOM_TATER);
            entries.add(NEItems.RED_MUSHROOM_TATER);
            entries.add(NEItems.RED_NETHER_BRICK_TATER);
            entries.add(NEItems.RED_SANDSTONE_TATER);
            entries.add(NEItems.RUBY_TATER);
            entries.add(NEItems.SANDSTONE_TATER);
            entries.add(NEItems.SEA_PICKLE_TATER);
            entries.add(NEItems.SHEEP_TATER);
            entries.add(NEItems.SHIELDED_WITHER_TATER);
            entries.add(NEItems.SNOW_FOX_TATER);
            entries.add(NEItems.SPIDER_TATER);
            entries.add(NEItems.SPRUCE_LOG_TATER);
            entries.add(NEItems.SQUID_TATER);
            entries.add(NEItems.STRAY_TATER);
            entries.add(NEItems.STRIDER_TATER);
            entries.add(NEItems.TURTLE_EGG_TATER);
            entries.add(NEItems.WARPED_NYLIUM_TATER);
            entries.add(NEItems.WARPED_STEM_TATER);
            entries.add(NEItems.WITHER_TATER);
            entries.add(NEItems.AZALEA_TATER);
            entries.add(NEItems.BELL_TATER);
            entries.add(NEItems.COLD_FROG_TATER);
            entries.add(NEItems.CONDUIT_TATER);
            entries.add(NEItems.ELDER_GUARDIAN_TATER);
            entries.add(NEItems.END_STONE_BRICK_TATER);
            entries.add(NEItems.FLOWER_POT_TATER);
            entries.add(NEItems.GUARDIAN_TATER);
            entries.add(NEItems.ILLAGER_TATER);
            entries.add(NEItems.ILLUSIONER_TATER);
            entries.add(NEItems.JUKEBOX_TATER);
            entries.add(NEItems.LANTERN_TATER);
            entries.add(NEItems.PIGLIN_TATER);
            entries.add(NEItems.PINK_WITHER_TATER);
            entries.add(NEItems.PISTON_TATER);
            entries.add(NEItems.PURPUR_TATER);
            entries.add(NEItems.SOUL_LANTERN_TATER);
            entries.add(NEItems.SOUL_SOIL_TATER);
            entries.add(NEItems.STICKY_PISTON_TATER);
            entries.add(NEItems.TEMPERATE_FROG_TATER);
            entries.add(NEItems.UNDERWATER_TNTATER);
            entries.add(NEItems.VEX_TATER);
            entries.add(NEItems.VILLAGER_TATER);
            entries.add(NEItems.VINDITATER);
            entries.add(NEItems.WANDERING_TRADER_TATER);
            entries.add(NEItems.WARM_FROG_TATER);
            entries.add(NEItems.WAX_TATER);
            entries.add(NEItems.WITCH_TATER);
            entries.add(NEItems.ZOMBIE_VILLAGER_TATER);
            entries.add(NEItems.ZOMBIFIED_PIGLIN_TATER);
            entries.add(NEItems.BONE_SPIDER_TATER);
            entries.add(NEItems.BOULDERING_ZOMBIE_TATER);
            entries.add(NEItems.CHARGED_CREEPER_TATER);
            entries.add(NEItems.LOBBER_ZOMBIE_TATER);
            entries.add(NEItems.MOSSY_SKELETATER);
            entries.add(NEItems.STRIPPED_ACACIA_LOG_TATER);
            entries.add(NEItems.STRIPPED_BIRCH_LOG_TATER);
            entries.add(NEItems.STRIPPED_CRIMSON_STEM_TATER);
            entries.add(NEItems.STRIPPED_DARK_OAK_LOG_TATER);
            entries.add(NEItems.STRIPPED_JUNGLE_LOG_TATER);
            entries.add(NEItems.STRIPPED_OAK_LOG_TATER);
            entries.add(NEItems.STRIPPED_SPRUCE_LOG_TATER);
            entries.add(NEItems.STRIPPED_WARPED_STEM_TATER);
            entries.add(NEItems.TROPICAL_SLIME_TATER);
            entries.add(NEItems.APPLE_TATER);
            entries.add(NEItems.GOLDEN_APPLE_TATER);
            entries.add(NEItems.ICE_TATER);
            entries.add(NEItems.KING_TATER);
            entries.add(NEItems.RAW_COPPER_TATER);
            entries.add(NEItems.RAW_GOLD_TATER);
            entries.add(NEItems.RAW_IRON_TATER);
            entries.add(NEItems.ALLAY_TATER);
            entries.add(NEItems.MANGROVE_LOG_TATER);
            entries.add(NEItems.MANGROVE_TATER);
            entries.add(NEItems.MUD_BRICK_TATER);
