...
public class NEEntities {
    public static final EntityType<QuickArmorStandEntity> QUICK_ARMOR_STAND_ENTITY_ENTITY_TYPE =
    ...
    public static void register() {
        register("quick_armor_stand", QUICK_ARMOR_STAND_ENTITY_ENTITY_TYPE);
        FabricDefaultAttributeRegistry.register(QUICK_ARMOR_STAND_ENTITY_ENTITY_TYPE, QuickArmorStandEntity.createLivingAttributes());
    }
